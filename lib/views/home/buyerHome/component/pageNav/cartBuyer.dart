    ...
    return Scaffold(
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            //***********************this text title nav bar
            const Text(
              'Shopping Cart',
              style: TextStyle(fontSize: 25),
            ),
            //***********************this text number of selected items by buyer
            ...
            Container(
                ...
                child: const Button(textButton: 'Buy Now'))
          ],
        ),
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
      InkWell(
          ...
          child: Container(
              alignment: Alignment.center, child: const Icon(Icons.remove))),
